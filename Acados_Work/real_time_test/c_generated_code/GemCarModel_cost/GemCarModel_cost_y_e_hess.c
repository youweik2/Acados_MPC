...
/* GemCarModel_cost_y_e_hess:(i0[4],i1[],i2[],i3[4],i4[],i5[627])->(o0[4x4,0nz]) */
...
CASADI_SYMBOL_EXPORT int GemCarModel_cost_y_e_hess_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
