...
from basempc.ros1_MPC import GemCarOptimizer, GemCarModel
...
class VehicleController():
    ...
    def mpc_interface(self):
        ...
        try:
            ...
            k = 0.82
            isteer = (self.wheelbase * target_o * k) / (self.speed * np.pi) if abs(self.speed) > 0.05 else 0.0
            self.steer_delta = np.degrees(round(np.clip(isteer, -0.61, 0.61), 3))
