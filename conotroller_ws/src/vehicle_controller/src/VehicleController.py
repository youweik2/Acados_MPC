...
class VehicleController():
    ...
    def wps_to_xy(self, lon_wp, lat_wp):
        ...
        print(lon_wp)
        print(lat_wp)
        lat_wp_y, lon_wp_x = ll2xy(lat_wp, lon_wp, self.olat, self.olon)    # need to add source code to provide support
        print(lon_wp_x)
        print(lat_wp_y)
    ...
    def kalman_filter(self):
        ...
        self.filtered_x, self.filtered_y, self.filtered_yaw = self.curr_x, self.curr_y, self.curr_yaw
    ...
    def mpc_interface(self):
        ...
        theta_real = self.angle / 180.0 * np.pi
        ...
        print(theta_real)
        print(vel_real)
        x_0, y_0, theta_0, vel, a_0, o_0 = self.opt.solve(x_real, y_real, theta_real, vel_real)
        ...
        self.accel_percent = target_a
        print("send acc")
        print(self.accel_percent)
        ...
        if (x_0 - self.target_x) ** 2 + (y_0 - self.target_y) ** 2 < 4:
            # break
